...
full.integrated_v2@meta.data$Tumor_Categories[full.integrated_v2@meta.data$sample_name %in% "PCNS1"] <- "Glioblastoma"
...
# Update to 2021!
full.integrated_v2@meta.data$Tumor_Categories[full.integrated_v2@meta.data$sample_name %in% "PCNS22"] <- "Astrocytoma"
```
...
for(i in tumor_types){
  ...
  write.csv(pathways_df, 
            paste0("~/OneDrive - Dartmouth College/PCNS/snRNAseq/VireoFiles/UpdatedFigures_2021WHO/ReactomePA/",
                   print(i), "vsNormal_unadj_ReactomePA_results.csv"))
}
```
