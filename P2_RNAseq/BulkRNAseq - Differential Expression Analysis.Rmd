...
# Reformat metadata
# Add onto meta data
meta_full2 <- merge(meta_final, prop_t, 
...
```{r}
meta_final$tissue <- ifelse(meta_final$Tumor_Categories %in% c("Non-Tumor"), "Non-Tumor", "Tumor")
meta_final$tissue <- factor(meta_final$tissue, levels = c("Non-Tumor", "Tumor"))
```
